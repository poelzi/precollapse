...
def timedelta_representer(dumper, data):
    return dumper.represent_scalar('!timedelta', str(data))

yaml.add_representer(datetime.timedelta, timedelta_representer)
yaml.add_representer(datetime.timedelta, timedelta_representer, Dumper=yaml.SafeDumper)

def timedelta_constructor(loader, node):
    value = loader.construct_scalar(node)
    return datetime.timedelta(seconds=timeparse(value))
    #return dumper.represent_scalar('!timedelta', str(data))

yaml.add_constructor(u'!timedelta', timedelta_constructor)
yaml.add_constructor(u'!timedelta', timedelta_constructor, Loader=yaml.SafeLoader)
